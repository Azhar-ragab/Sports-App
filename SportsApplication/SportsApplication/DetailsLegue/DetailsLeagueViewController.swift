...
class DetailsLeagueViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    override func viewDidLoad() {
        ...
        data.delegate = self
        data.retriveData()
        self.upComingCollection.backgroundColor = #colorLiteral(red: 0.5176470588, green: 0.5450980392, blue: 0.4745098039, alpha: 1)
         self.letestCollection.backgroundColor = #colorLiteral(red: 0.5176470588, green: 0.5450980392, blue: 0.4745098039, alpha: 1)
         self.teamCollection.backgroundColor = #colorLiteral(red: 0.5176470588, green: 0.5450980392, blue: 0.4745098039, alpha: 1)
          self.view.backgroundColor = #colorLiteral(red: 0.5176470588, green: 0.5450980392, blue: 0.4745098039, alpha: 1)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if(collectionView == letestCollection){
            ...
            latestCell.layer.borderColor = #colorLiteral(red: 0.6156862745, green: 0.7607843137, blue: 0.03529411765, alpha: 1)
       ...
       let teamCell = teamCollection.dequeueReusableCell(withReuseIdentifier: teamIdentifier, for: indexPath) as! TeamCollectionViewCell
         ...
         teamCell.imgTeam?.sd_setImage(with: URL(string: teamArray[indexPath.row].teamBadge), placeholderImage: UIImage(named: "placeholder.png"))
            teamCell.layer.borderColor = #colorLiteral(red: 0.6156862745, green: 0.7607843137, blue: 0.03529411765, alpha: 1)
            teamCell.layer.borderWidth = 2
            return teamCell

        }
         upComingCell.layer.borderColor = #colorLiteral(red: 0.6156862745, green: 0.7607843137, blue: 0.03529411765, alpha: 1)
